...
Next time, I would really like to try and spent a zealous amount of time on planning behavior in such a way that a branch is therotically explored until no conceivable edge case is left undiscovered, and then divide those behaviors up into branches. These branches I would then like to itertatively work on, building tiny feature upon tiny feature. 
